...
<a href="/Npm21312087/create" class="btn btn-secondary mb-3">Tambah data</a>
<table class="table" id="example1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="/Npm21312087/{{ $item->id }}" method="POST">
                <a href="/Npm21312087/{{ $item->id }}/edit" class="btn btn-warning btn-sm">Edit</a>
                    @csrf
                    @method('delete')
